-- Remove duplicate notification from create_match_atomic.
-- The notify_new_match trigger on matches already creates a detailed notification,
-- so the INSERT INTO notifications inside the RPC causes duplicates.
...
BEGIN
  ...
  -- Insert match (notify_new_match trigger handles notification)
